    ...
    def handle(self, *args, **options):
        ...
        for path in Path('distributions/data').iterdir():
            ...
            for row in table:
                ...
                section.percent_As = row['As']
                section.percent_Bs = row['Bs']
                section.percent_Cs = row['Cs']
                section.percent_Ds = row['Ds']
                section.percent_Fs = row['Fs']
                section.number_withdrawals = row['Textbox10']
                section.number_students = row['number']
                section.save()
        print('done')